...
However the tasks of the Post-Extraction-Phase are mandatory before the Analysis-Phase starts. Therfore reuse of the component that implements the tasks is of paramount importance. Consequently \texttt{IncrementalPostExtraction} is written as an \texttt{AnalysisComponent}.
...
\subsubsection{Individual Performance per Execution}
