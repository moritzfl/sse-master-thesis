...
This chapter provides an introduction to related topics that the reader should be aware of. \todo{hier mehr Text vor dem ersten Unterkapitel}
...
\todo{modify figure with make space, remove numbers}
